 ...
 */
static rb_node_t *rb_node_create(void *key, void *data, size_t key_size, size_t data_size)
{
	rb_node_t *rb_node;
...
rb_tree_t *rb_tree_create(int (*f) (const void *, const void *), size_t ksz, size_t dsz)
{
	rb_tree_t *rb_tree;
 ...
 */
static void __swap_color(rb_node_t *node_a, rb_node_t *node_b)
{
	int tmp = node_a->color;
 ...
 */
static void __rb_tree_rotate_left(rb_tree_t *rb_tree, rb_node_t *rb_node)
{
 ...
 * @rb_node: the node which causes the need of rotation
 */
static void __rb_tree_rotate_right(rb_tree_t *rb_tree, rb_node_t *rb_node)
{
 ...
 */
static int __check_violation(rb_tree_t *rb_tree, rb_node_t *rb_node)
{
	return (
 ...
 */
static void __rb_tree_insert_fix(rb_tree_t *rb_tree, rb_node_t *rb_node)
{
...
rb_node_t *rb_tree_insert(rb_tree_t *rb_tree, void *key, void *data)
{
	int rc;
...
void *rb_tree_find(rb_tree_t *rb_tree, void *key)
{
	int rc;
...
static void __rb_tree_free(rb_node_t *root, void (*f_key)(void *), void (*f_data)(void *))
{
	if (!root) {
		return;
	}
...
void rb_tree_free(rb_tree_t *rb_tree, void (*f_key)(void *), void (*f_data)(void *))
{
